describe.skip('harchi2', () => {
    it('harchi it2', () => {
        // harchi
    });
});

// import { readTasks, createTask, updateTask, deleteTask } from '../../../src/repositories/task-repository';
...
//         },
//     ]),
//     createData: jest.fn().mockImplementationOnce(async (title: string) => ({
//         id: '289b0d16-e06d-4a71-a0dd-123iui434pp9',
//         title,
//     })),
//     updateData: jest.fn().mockImplementationOnce(async (id: string, newTitle: string) => ({
//         id,
//         title: newTitle,
//     })),
//     deleteData: jest.fn().mockImplementationOnce(async (id: string) => ({})),
// }));

// // import * as persistData from '../../../src/helpers/persist-data';
// const persistData: any = [];

// describe.skip('task-repositories', () => {
